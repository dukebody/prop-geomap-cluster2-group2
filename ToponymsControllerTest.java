...
public class CitiesControllerTest extends TestCase {
    ...
    public void setUp() throws Exception {
        ...
        tc.createCityType("City A", "City", "CA");
        tc.createCityType("City B", "City", "CB");

        tc.addCity("Madrid", "Madrid", 34.3332, 12.4333, "CA");
        tc.addCity("Barcelona", "Barcelona", 12.14, 1.2333, "CA");
        tc.addCity("Norilandia", "Ñorilandia", 35.2, 46.24, "CA");
        tc.addCity("Norilandia", "Norilandia", 36.2, 49.24, "CB");
        tc.addCity("Mandril", "Mandril", 45.14, 22.563, "CB");
        tc.addCity("Mandril", "Mandril", 45.18, 22.580, "CB");
    }
    ...
    @Test
    public void testGetCityType() {
        System.out.println("Testing getCityType...");

        System.out.print("Checking that getting an existing city by code returns the related map...");
        HashMap<String,String> type = tc.getCityType("CA");
        ...
        assertNull(tc.getCityType("BADCODE"));
        System.out.println("OK");
    }

    @Test 
    public void testGetCityTypesIterator() {
        System.out.println("Testing getCityTypesIterator...");

        Iterator<HashMap<String,String>> types = tc.getCityTypesIterator();
        int count = 0;
        while (types.hasNext()) {
            types.next();
            count++;
        }
        System.out.print("\tChecking getCityTypesIterator returns an iterator to all the city types...");
    ...
    public void testGetMapCity() {
        ...
        HashMap<String,String> map = tc.getMap(new City("Madrid", "Madrid", 34.3332, 12.4333, cityA));
    ...
    @Test
    public void testGetMapCityType() {
        System.out.print("Testing getMap for a single citytype...");
    ...
    public void testAddCity() {
        ...
        assertTrue(tc.addCity("Zaragoza", "Zaragoza", 45.19, 22.580, "CA"));
        System.out.println("OK");
    ...
    public void testAddCityWithWrongData() {
        ...
        System.out.print("\tChecking that adding a city in a free location returns true...");
        assertFalse(tc.addCity("Zaragoza", "Zaragoza", 555.19, 22.580, "CA"));
        System.out.println("OK");
    }
    ...
    public void testAddCityOnExistingOneFails() {
        ...
        assertFalse(tc.addCity("Zaragoza", "Zaragoza", 12.14, 1.2333, "CA"));
        System.out.println("OK");
    ...
    public void testModifyCity() {
        ...
        assertTrue(tc.modifyCity("Madrid", id, "Almeria", "Almería", 33.2224, 24.5555, "CB"));
        System.out.println("OK");
    ...
    public void testModifyNonExistingCity() {
        ...
        assertFalse(tc.modifyCity("Madrid", "3000", "Almeria", "Almería", 33.2224, 24.5555, "CA"));
        System.out.println("OK");
    ...
    public void testModifyExistingCityWrongData() {
        ...
        assertFalse(tc.modifyCity("Madrid", id, "Almeria", "Almería", 6000.00, 43.2, "CB"));
        System.out.println("OK");
